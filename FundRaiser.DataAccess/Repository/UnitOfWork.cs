...
namespace FundRaiser.DataAccess.Repository
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(ApplicationDbContext db)
        {
            ...
            ProjectCreator = new ProjectCreatorRepository(_db);
            Backer = new BackerRepository(_db);
        }
        ...
        public IBackerRepository Backer { get; private set; }
        public IProjectCreatorRepository ProjectCreator { get; private set; }
        public void Dispose()
        {
            _db.Dispose();
        }
