        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackersSum = table.Column<int>(type: "int", nullable: false),
                    TotalPledged = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectGoal = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BackerProject", x => new { x.BackersId, x.InvestedProjectsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BackerProject_Project_InvestedProjectsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Benefit_Project_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BackerBenefit", x => new { x.BackersId, x.BenefitsId });
                    table.ForeignKey(
                        name: "FK_BackerBenefit_Backer_BackersId",
                        column: x => x.BackersId,
                        principalTable: "Backer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BackerBenefit_Benefit_BenefitsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContainsBenefit = table.Column<bool>(type: "bit", nullable: false),
                    InvestedVolume = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transaction_Backer_BackerId",
                        column: x => x.BackerId,
                        principalTable: "Backer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transaction_Benefit_BenefitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BackerBenefit_BenefitsId",
                table: "BackerBenefit",
                column: "BenefitsId");

            migrationBuilder.CreateIndex(
                name: "IX_BackerProject_InvestedProjectsId",
                table: "BackerProject",
                column: "InvestedProjectsId");

            migrationBuilder.CreateIndex(
                name: "IX_Benefit_ProjectId",
                table: "Benefit",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaction_BackerId",
                table: "Transaction",
                column: "BackerId");

            migrationBuilder.CreateIndex(
                name: "IX_Transaction_BenefitId",
                table: "Transaction",
                column: "BenefitId");
